...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post slots_url, params: { slot: { screen_id: @slot.screen_id, slot_time: @slot.slot_time } }, as: :json
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { screen_id: @slot.screen_id, slot_time: @slot.slot_time } }, as: :json
    assert_response 200
  end
